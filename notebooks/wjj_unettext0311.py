import argparse
from Prompt_sam_localization.notebooks.function_token import loss_function
...
from RegionMAELoss import RegionMAELoss
...
if __name__ == '__main__':
    ...
    if args.mode == 'test':
        ...
        train_dataloader = DataLoader(train_data, batch_size=args.bs, shuffle=False)
